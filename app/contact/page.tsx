...
const ContactForm: React.FC = () => {
    ...
    const selectedDateRef = useRef<Dayjs | null>(null);
    ...
    const handleDateChange = (date: Dayjs | null) => {
        ...
        setSelectedDate(date); // Update state if needed
    ...
    const handleSubmit = () => {
        if (selectedDateRef.current) {
            const formatted = selectedDateRef.current.format("Do MMMM YYYY");
            setFormattedDate(formatted); // Store in state
